...
def main():
    ...
    with st.sidebar:
        ...
        # -------------------------------------------------
        # Live progress + metrics -- runs as an isolated
        # fragment so ONLY this block refreshes on a timer,
        # instead of the whole page (sidebar, history table,
        # webrtc component, etc.) reloading every 250ms.
        # -------------------------------------------------
